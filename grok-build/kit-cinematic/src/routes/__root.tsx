...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Kit — Websites that make the phone ring" },
      {
        name: "description",
        content:
          "Hand-built one-page websites for local businesses in The Woodlands, Spring, and Conroe. $350 flat. Free preview first. DM KIT.",
      },
