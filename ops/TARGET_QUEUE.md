...
Status key: `live` = public URL serving. `queued` = next builder. `blocked` = cash/API. `killed` = filter.

| ID | Target | Proof | Job | Builder | Status | Live URL |
|---|---|---|---|---|---|---|
| T01 | Instasize analog | IdeaWave $12.5M/mo | Resize image for social | in-repo `apps/framefit` | live | https://framefit-eta.vercel.app + /framefit.html |
| T02 | qi-check (own niche) | Experiment spec locked | Score first-screen / Hold | `apps/qi-check` | live | https://autonomous-revenue-engine-eight.vercel.app/qi-check.html |
| T03 | Stan.store analog | IdeaWave $3.6M/mo | Link-in-bio page | in-repo static | live | https://autonomous-revenue-engine-eight.vercel.app/linknest.html |
