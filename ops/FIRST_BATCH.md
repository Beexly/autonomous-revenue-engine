...
**Date:** 2026-08-24 (updated 2026-09-12 cycle 17)  
**Authorship:** Human-primary idea/angle/data. AI production only.  
**Published:** 0. This file is not a publish queue.

| ID | Title | Total | Min | Disposition | Tier | Next |
|---|---|---|---|---|---|---|
| SO-001 | Your timeline is a club now | 48 | 7 | Pass | A | Internal queue only |
| SO-004 | I ran a classifier simulation on my own draft | 50 | 8 | Pass | A | Internal queue only |
| SO-007 | White space in a crowded name | 48 | 7 | Pass | A | Internal queue only |
| SO-002 | Qualified impressions are the only impressions | 47 | 7 | Pass | A | Internal queue only — see ops/SO002_REWRITE.md |
| SO-005 | Burrows Delta is a better voice check than vibes | 48 | 7 | Pass | A | Internal queue only — see ops/SO005_REWRITE.md |
| SO-008 | The market already voted against packaged prompts | 38 | 5 | Hold | B | Hold as public copy until niche has named public face (niche = qi-check; experiment spec in ops/EXPERIMENT_NICHE.md) |
...
**2026-09-01 cycle 9:** Re-confirmed SO-002/SO-005 Pass (no redo). Domain probes still inconclusive (could-not-resolve). Publish path remains disabled.

**2026-09-03 cycle 10:** Re-confirmed SO-002/SO-005 Pass (no redo). Domain probes still inconclusive (HTTP 000/fail). Publish path remains disabled.

**2026-09-04 cycle 11:** Re-confirmed SO-002/SO-005 Pass (no redo). Domain probes still inconclusive (HTTP 000/fail). Publish path remains disabled.

**2026-09-05 cycle 12:** Re-confirmed SO-002/SO-005 Pass (no redo). Domain probes still inconclusive (HTTP 000/fail). Publish path remains disabled.

**2026-09-06 cycle 13:** Re-confirmed SO-002/SO-005 Pass (no redo). Domain probes: most shortlist 000/fail; holdscore.com 200 (parked lander) — deprioritize. Publish path remains disabled.
...
**2026-09-12 cycle 17:** Re-confirmed SO-002/SO-005 Pass (no redo). Domain probes: most shortlist 000/fail; holdscore.com 200 (parked lander) — deprioritize. Publish path remains disabled.
